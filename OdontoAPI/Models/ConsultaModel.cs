...
namespace OdontoAPI.Models
{
    public class ConsultaModel
    {
        ...
        [Required]
        public DentistaModel DentistaAssociado { get; set; } // Meu EF entende que o DentistaAssociado (obj) é a coluna de id_dentista_associado no banco de dados
        [Required]
        public PacienteModel PacienteAssociado { get; set; } // Meu EF entende que o PacienteAssociado (obj) é a coluna de id_paciente_associado no banco de dados
